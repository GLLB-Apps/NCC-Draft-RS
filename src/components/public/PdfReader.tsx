...
/** Appwrites /view visar filen i webbläsaren, /download tvingar nedladdning. */
export const downloadUrl = (url: string) => url.replace('/view?', '/download?')
      ...
      <div className="pdf-reader-panel" onClick={e => e.stopPropagation()}>
        <div className="pdf-reader-bar">
          ...
          <div className="pdf-reader-actions">
            ...
            <a href={downloadUrl(doc.url)} className="btn btn-secondary btn-sm">Ladda ner</a>
